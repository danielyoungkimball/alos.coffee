        ...
        items: [
          {
            ...
            name: "☕ Americano",
            price: 60,
            image: "/menu-items/americano.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 2,
            name: "☕ Cappuchino",
            price: 65,
            image: "/menu-items/cappuchino.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 3,
          ...
          },
          {
            ...
            name: "🍮 Caramel Latte",
            price: 95,
            image: "/menu-items/caramel-latte.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 6,
            name: "🍦 Vainilla Latte",
            price: 95,
            image: "/menu-items/vainilla-latte.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 7,
            name: "🌰 Avellana Latte",
            price: 95,
            image: "/menu-items/avellana-latte.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 8,
            name: "🍵 Matcha Latte",
            price: 100,
            image: "/menu-items/matcha-latte.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 9,
            name: "🍵 Chai Latte",
            price: 90,
            image: "/menu-items/chai-latte.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
          {
            id: 10,
            name: "🍫 Chocolate",
            price: 80,
            image: "/menu-items/chocolate.png",
            possibleAddons: DRINK_ADDON_KEYS,
          },
        ],
      },
        ...
        items: [
          {
            ...
            name: "🍊 Naranja",
            price: 60,
            image: "/menu-items/naranja.png",
          },
          {
            id: 12,
            name: "🥤 Verde",
            price: 80,
            description: "(Jugo de naranja, nopal, espinaca, apio, piña)",
            image: "/menu-items/verde.png",
          },
          {
            id: 13,
            name: "🥕 Zanahoria",
            price: 60,
            image: "/menu-items/zanahoria.png",
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            price: 0,
            description: "(Preguntar por disponibilidad)",
          }, // image: "/menu-items/postre-semana.png"
          {
            id: 15,
            name: "🥞 Crepas de avena",
            price: 75,
            description: "Dos toppings a elegir",
            possibleAddons: CREPE_TOPPING_KEYS,
            image: "/menu-items/crepas-avena.png",
          },
          {
            id: 16,
            name: "🥞 Hot Cakes de avena",
            price: 65,
            description: "Con miel y mantequilla",
            possibleAddons: ["frutas"],
            image: "/menu-items/hot-cakes-avena.png",
          },
          {
            id: 17,
            name: "🧇 Marquesitas",
            price: 60,
            description: "Con Queso de Bola y\nuno topping a elegir",
            possibleAddons: CREPE_TOPPING_KEYS,
          }, //image: "/menu-items/marquesitas.png",
          {
            id: 18,
            name: "🥪 Mini Sandwich de manzana",
            price: 65,
            description: "Con lechera y granola",
          }, //image: "/menu-items/mini-sandwich-manzana.png"
          {
            id: 19,
            name: "🍞 Pan francés",
            price: 130,
            description: "Con frutos rojos y crema batida",
            image: "/menu-items/pan-frances.png",
          },
          {
            id: 20,
            name: "🍓 Fresas con crema",
            price: 85,
            description: "Con lechera y dos toppings",
            possibleAddons: FRESAS_TOPPING_KEYS,
          }, //image: "/menu-items/fresas-crema.png",
        ],
      },
    ],
  },
...
function calculateTotalPrice(
  ...
  if (
    itemName &&
    (itemName.toLowerCase().includes("crepa") ||
      itemName.toLowerCase().includes("fresas con crema"))
  ) {
    if (addons.length <= 2) {
      ...
      const addonTotal = paidAddons.reduce(
...
export default function Home() {
  ...
  function addToCart(item: {
    ...
    if (
      item.name.toLowerCase().includes("crepa") ||
      item.name.toLowerCase().includes("fresas con crema")
    ) {
  ...
  function handlePhoneChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (country === "MX" && !formattedPhone.startsWith("52"))
      formattedPhone = "52" + formattedPhone;
    if (country === "US" && !formattedPhone.startsWith("1"))
      formattedPhone = "1" + formattedPhone;
    if (!validatePhone(formattedPhone)) {
      setPhoneError(
        country === "MX"
          ? "El número debe tener 10 dígitos para México"
          : "Phone number must be 10 digits for US"
      );
    } else {
      setPhoneError("");
    }
  ...
  async function handleCheckout(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (payment !== "transferencia") {
      if (!validatePhone(formattedPhone)) {
        setPhoneError(
          "Por favor ingresa un número válido (10 dígitos) para " +
            (country === "MX" ? "México" : "EE.UU.")
        );
        valid = false;
      }
    ...
    if (!valid) return;
    clientLogger.info("Checkout submitted", {
      name,
      apartment,
      cart,
      payment,
    ...
    if (payment === "transferencia") {
      if (!name || cart.length === 0) {
        clientLogger.warn("Transfer checkout validation failed", {
          name,
          cart,
        });
      ...
      if (!name || !apartment || cart.length === 0) {
        clientLogger.warn("Checkout validation failed", {
          name,
          apartment,
          cart,
        });
        alert(
          "Por favor llena tu nombre, dirección y agrega productos al carrito."
        );
        return;
      }
    }
  ...
  function openCustomizeModal(item: MenuItem) {
    ...
    if (
      ...
      item.name.toLowerCase().includes("cappuchino") ||
      item.name.toLowerCase().includes("moka") ||
  ...
  return (
    <div className="bg-parchment min-h-screen text-black font-nunito relative z-10 overflow-hidden">
      ...
      <section className="flex flex-col items-center justify-center min-h-[60vh] md:min-h-[80vh] text-center p-4 md:p-8">
        <h2 className="text-3xl md:text-5xl font-sansita font-bold mb-4 text-verde">
          Menú
        </h2>
        <div className="space-y-10 w-full max-w-3xl">
          {filteredMenu.map((section) => (
            <div key={section.category}>
              <h2 className="text-2xl md:text-3xl font-sansita font-bold mb-4 text-verde">
                {section.category}
              </h2>
              {section.groups.map((group) => (
                <div key={group.name} className="mb-6">
                  <h3 className="text-xl font-bold mb-2 text-verde">
                    {group.name}
                  </h3>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 flex flex-col justify-between w-full items-center mt-2">
                            <span className="font-bold text-lg text-verde text-center">
        ...
        {cartDrawerOpen && (
          <>
            ...
            />
            <aside
              className="fixed md:top-0 md:right-0 md:h-full md:w-full md:max-w-md bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out md:translate-x-0 bottom-0 left-0 w-full h-[80vh] rounded-t-2xl md:rounded-none md:bottom-auto md:left-auto md:rounded-none "
              style={{
                transform: cartDrawerOpen
                  ? "translateY(0)"
                  : "translateY(100%)",
              }}
            >
              <div className="relative h-full flex flex-col p-6">
                      ...
                      {cart.map((item) => {
                        ...
                        return (
                          <li
                            ...
                            className="flex flex-col gap-1 mb-4 pb-4 border-b border-gray-200"
                          >
                            <div className="flex justify-between items-center">
                              <span className="font-bold text-lg flex items-center gap-2">
                                {item.qty} x {item.name}
                              </span>
                              <span className="font-bold text-verde text-lg">
                                ${item.totalPrice || item.price} MXN
                              </span>
                            </div>
                            <div className="flex flex-col ml-2 mt-1 gap-1">
                              ...
                              {item.options?.hotCold && (
                                <span className="text-sm">
                                  •{" "}
                                  {item.options.hotCold === "frio"
                                    ? "Frío"
                                    : "Caliente"}
                                </span>
                              )}
                                ...
                                item.options.addons.length > 0 && (
                                  <div className="text-sm flex flex-col gap-0.5 mt-1">
                                    ...
                                    {isSpecialToppingItem && (
                                      <span className="text-xs text-gray-500">
                                        Primeros 2 toppings gratis, después se
                                        cobra cada uno.
                                      </span>
                                    )}
                    ...
                    <div className="border-t pt-3 mb-3">
                      <div className="flex justify-between items-center text-lg font-bold">
                        ...
                        <span className="text-verde">
                          ...
                          {cart.reduce(
                            (sum, item) =>
                              sum + (item.totalPrice || item.price) * item.qty,
                            0
                          )}{" "}
                          MXN
                        </span>
                ...
                <form onSubmit={handleCheckout} className="flex flex-col gap-3">
                  <input
                    ...
                    required
                    className="p-2 rounded border border-gray-300 text-black bg-white placeholder-gray-400"
                  ...
                  <input
                    ...
                    placeholder="Dirección / Departamento / Casa"
                  />
                  {addressError && (
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <label className="flex items-center gap-1">
                      <input
                        ...
                        onChange={() => {
                          setPayment("cash");
                          clientLogger.info("Payment method selected", "cash");
                        }}
                      />{" "}
                      Efectivo
                      <input
                  ...
                  {payment === "transferencia" && (
                    <div className="mb-2 p-3 bg-gray-50 rounded border">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        <p>
                          <strong>Número de cuenta:</strong> 4152314138047454
                        </p>
                        <p>
                          <strong>Titular:</strong> Alondra Higareda
                        </p>
                      </div>
                      <p className="text-xs text-gray-500 mt-2">
                        Realiza la transferencia y envía el comprobante por
                        WhatsApp
                      </p>
                    </div>
                  )}
                  <button
                    type="submit"
                    className="mt-2 mb-2 px-6 py-3 bg-green-600 text-white rounded-lg font-bold text-lg shadow hover:bg-green-700 transition-colors w-full"
                  >
                    Checkout
                  </button>
                </form>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full flex flex-col items-center">
            ...
            <p className="mb-4 text-center">
              Copia este mensaje y envíalo por WhatsApp al{" "}
              <a
                href="https://wa.me/526242653144"
                target="_blank"
            ...
            <div className="flex gap-2 w-full">
              <button
                className="flex-1 bg-green-600 text-white rounded px-4 py-2 font-bold"
                onClick={() => {
              ...
              <a
                className="flex-1 bg-verde text-white rounded px-4 py-2 font-bold text-center"
                href={`https://wa.me/526242653144?text=${encodeURIComponent(
                  waMsg
                )}`}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <button
              ...
              onClick={() => setShowWhatsAppMsg(false)}
            >
              Cerrar
            </button>
          </div>
      ...
      {customizingItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full flex flex-col items-center">
            <h2 className="text-xl font-bold mb-2 text-verde">
              Personaliza tu pedido
            </h2>
            <p className="mb-2 text-center font-semibold">
              {customizingItem.name}
            </p>
            <p className="mb-2 text-center text-gray-500 font-semibold">
            ...
            {/* Hot/Cold for drinks */}
            {customizingItem.name.match(
              /americano|latte|cappuchino|moka|chai|matcha|chocolate/i
            ) && (
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 rounded px-2 py-1 border ${
                      customOptions.hotCold === "caliente"
                        ? "bg-verde text-white"
                        : "bg-gray-100"
                    }`}
                    onClick={() =>
                      setCustomOptions((o) => ({ ...o, hotCold: "caliente" }))
                    }
                  >
                    Caliente
                  </button>
                  <button
                    type="button"
                    className={`flex-1 rounded px-2 py-1 border ${
                      customOptions.hotCold === "frio"
                        ? "bg-verde text-white"
                        : "bg-gray-100"
                    }`}
                    onClick={() =>
                      setCustomOptions((o) => ({ ...o, hotCold: "frio" }))
                    }
                  >
                    Frío
                  </button>
            ...
            {customizingItem.name.match(
              /americano|latte|cappuchino|moka|chai|matcha|chocolate|naranja|verde|zanahoria/i
            ) && (
              <div className="mb-2 w-full">
            ...
            {/* Add-ons/toppings */}
            {customizingItem.possibleAddons &&
              customizingItem.possibleAddons.length > 0 && (
                <div className="mb-2 w-full">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {customizingItem.possibleAddons.map((key) => {
                      ...
                      const isSpecialToppingItemOnlyOne = ["marquesita"].some(
                        (keyword) =>
                          customizingItem.name.toLowerCase().includes(keyword)
                      );
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 py-1 rounded border text-xs ${
                            customOptions.addons.includes(String(key))
                              ? "bg-verde text-white"
                              : "bg-gray-100"
                          }`}
                        ...
                        >
                          ...
                          {isSpecialToppingItem
                            ? selectedCount >= 2 &&
                              ALL_ADDONS[String(key)].price > 0 &&
                              !customOptions.addons.includes(String(key))
                              ? ` (+$${ALL_ADDONS[String(key)].price})`
                              : ""
                            : ""}
                          {/* Special topping item with 1 free topping */}
                          {isSpecialToppingItemOnlyOne
                            ? selectedCount >= 1 &&
                              ALL_ADDONS[String(key)].price > 0 &&
                              !customOptions.addons.includes(String(key))
                              ? ` (+$${ALL_ADDONS[String(key)].price})`
            ...
            <div className="mb-2 w-full text-center">
              ...
              {customOptions.addons.length > 0 && (
                <div className="text-xs text-gray-500">
                  Base: ${customizingItem.price} + Add-ons: $
                  {calculateTotalPrice(
                    customizingItem.price,
                    customOptions.addons,
                    customizingItem.name
            ...
            <div className="mb-2 w-full">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCustomOptions((o) => ({ ...o, notes: e.target.value }))
                }
            ...
            <div className="flex gap-2 w-full mt-2">
              ...
              <button
                className="w-10 h-10 bg-gray-300 text-black rounded font-bold flex items-center justify-center"
