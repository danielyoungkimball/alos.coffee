...
export default function Contact() {
  return (
    <div className="bg-parchment min-h-screen flex flex-col items-center justify-center text-center p-4">
      ...
      <p className="max-w-xl text-lg mb-6 text-richBlack">¿Tienes preguntas, sugerencias o quieres hacer un pedido especial? ¡Estamos aquí para ti!</p>
      ...
      <div className="flex flex-col items-center gap-2 text-richBlack">
